        ...
        private string ConvertNumberToAlpha(string Number)
        {
            if (Number.Contains('.'))
            {
                ...
                else
                {
                    ...
                    switch (Number.Split('.')[0].ToCharArray().Length)
                    {
                        case 1: return convertOneDigits(Number.ToString())  + " و " + convertTwoDigits(Number.Split('.')[1]);
                        case 2: return convertTwoDigits(Number.ToString())  + " و " + convertTwoDigits(Number.Split('.')[1]) ;
                        case 3: return convertThreeDigits(Number.ToString())  + " و " + convertTwoDigits(Number.Split('.')[1]) ;
                        case 4: return convertFourDigits(Number.ToString()) + " و " + convertTwoDigits(Number.Split('.')[1]) ;
                        case 5: return convertFiveDigits(Number.ToString())  + " و " + convertTwoDigits(Number.Split('.')[1]);
                        case 6: return convertSixDigits(Number.ToString())  + " و " + convertTwoDigits(Number.Split('.')[1]) ;
                        default: return "";
                    }
